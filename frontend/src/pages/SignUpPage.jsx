...
const SignUpPage = () => {
  ...
  return (
    ...
    <motion.div  // "motion" div for Annimation
        className='sm:mx-auto sm:w-full sm:max-w-md'
        initial={{ opacity: 0, y: -20 }}  // "motion" div for Annimation
                ...
                <div>
                    ...
                    <div className='mt-1 relative rounded-md shadow-sm'>
                        <div className='absolute inset-y-0 left-0 pl-3 flex items-center pointer-events-none'>                           
                            <User className='h-5 w-5 text-gray-400' aria-hidden='true' />  {/* imported icon */} 
                        </div>
                        <input
                            id='name'
                            type='text'
