...
const GiftCouponCard = () => {
	...
	useEffect(() => {  // getting the coupon if we have it
		getMyCoupon();
	}, [getMyCoupon]);
	...
	const handleRemoveCoupon = async () => {
		await removeCoupon();
		setUserInputCode("");  // this is empty string coz coupon is removed
	};
	...
	return (
		...
		>
            ...
            {/* coupon is applied when we have 200 dollers plus shopping */}
